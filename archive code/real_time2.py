...
while cap.isOpened():
    ...
    if success:
        ...
        # Ensure boxes is not None before proceeding
        if results[0].boxes is not None and results[0].boxes.id is not None:
            ...
            # Handle the case where no boxes are detected, e.g., by skipping this iteration or providing a warning.
            #nothing_frame = results[0].plot()
